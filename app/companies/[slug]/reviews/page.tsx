...
export default async function CompanyReviewsPage({
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      <h1 className="text-2xl font-bold text-[#222222] mb-2">{company.name} Reviews</h1>
      <p className="text-[#717171] mb-8">Employee reviews and culture insights</p>
      <div className="bg-white rounded-xl border border-[#EBEBEB] p-10 text-center">
        <span className="text-4xl mb-4 block">⭐</span>
        <h2 className="text-lg font-semibold text-[#222222] mb-2">Reviews coming soon</h2>
